...
export default {
  ...
  hz: "Creek cuts ACROSS the middle (forced carry) · pond low-left off the tee · river down the upper-LEFT · GREEN IS PINCHED — river tight left, pond biting in from the right — a narrow neck · waste + trees right",
  dzL: "water",
  dzR: "water",
  ...
  hazards: [
    ...
    { side: "L", type: "water", from: 0.55, to: 1.00 },   // river down the upper-left, tight to the green-left
    { side: "R", type: "sand",  from: 0.45, to: 0.66 },   // waste/bunker area right of the landing
    { side: "R", type: "trees", from: 0.66, to: 0.82 },   // tree line up the right
    { type: "water", pool: [0.80, 1.00, 0.56, 0.86] },    // pond biting in from the right — pinches the green neck
  ],
  carry: 170,             // carry the creek that crosses the middle (approx, back tee)
  carryLabel: "the creek",
  corner: 200,
  cornerLabel: "landing",
  green: { toPin: 382, guard: "pinched neck — river tight left, pond biting from the right", pinch: true, reference: "hardwired flag" },
  landing: { target: 200, leaves: 182, note: "~200 up the center carries the creek and leaves ~182 to a pinched green — attack only with a high-confidence number, else lay up" },
